...
def run_reactive_docking(ligand_prepared, receptor_prepared, reactive_residues):
...
def run_job(ligand, receptor, box, dirname, reactive_groups=None, reactive_residues=None):
    try:
